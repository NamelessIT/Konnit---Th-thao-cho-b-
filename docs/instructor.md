...
- [E. Task Group 3 — Backend: database & auth](#e-task-group-3--backend-database--auth) ⏳ PARTIAL (schema + seed done, auth routes TODO)
- [F. Task Group 4 — Backend: CMS core API](#f-task-group-4--backend-cms-core-api)
- [G. Task Group 5 — Backend: upload & audit](#g-task-group-5--backend-upload--audit)
- [H. Task Group 6 — Frontend: bootstrap SSR + shadcn/ui](#h-task-group-6--frontend-bootstrap-ssr--shadcnui)
...
## E. Task Group 3 — Backend: database & auth ⏳ NEXT
